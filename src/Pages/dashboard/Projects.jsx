...
const Card = ({ children, className = "" }) => (
  <div className={`relative group ${className}`}>
    <div className="absolute -inset-0.5 bg-gradient-to-r from-[#073F6F] to-[#315589] rounded-2xl blur opacity-10 group-hover:opacity-25 transition duration-500" />
...
const InputField = ({
  ...
  <div className="space-y-1.5">
    ...
    <input
      ...
      required={required}
      className="w-full bg-[#061A2F] border border-white/10 rounded-xl px-4 py-2.5 text-gray-200 placeholder-gray-600 text-sm outline-none focus:border-blue-500/60 focus:ring-1 focus:ring-blue-500/20 transition-all"
    />
  </div>
);
...
const SkeletonCard = () => (
  <div className="relative">
    <div className="absolute -inset-0.5 bg-gradient-to-r from-[#073F6F] to-[#315589] rounded-2xl blur opacity-10" />
...
const Modal = ({ title, onClose, children }) => (
  <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6">
    ...
    >
      <div className="absolute -inset-0.5 bg-gradient-to-r from-[#073F6F] to-[#315589] rounded-2xl blur opacity-20 pointer-events-none" />
    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="sm:col-span-2 space-y-1.5">
          ...
          <textarea
            ...
            rows={3}
            className="w-full bg-[#061A2F] border border-white/10 rounded-xl px-4 py-2.5 text-gray-200 placeholder-gray-600 text-sm outline-none focus:border-blue-500/60 focus:ring-1 focus:ring-blue-500/20 transition-all resize-none"
          />
        </div>
        ...
        <div className="sm:col-span-2 space-y-1.5">
          ...
          <label className="flex items-center gap-4 w-full bg-[#061A2F] border border-dashed border-white/15 rounded-xl px-4 py-4 cursor-pointer hover:border-blue-500/40 hover:bg-white/4 transition-all">
            {preview ? (
              <img
                src={preview}
      ...
      <div className="flex justify-end gap-2 pt-1">
        ...
        <button type="submit" disabled={uploading} className="relative group/s">
          <div className="absolute -inset-0.5 bg-gradient-to-r from-[#052F55] to-[#315589] rounded-xl opacity-60 blur group-hover/s:opacity-100 transition duration-300" />
          <div className="relative flex items-center gap-2 px-5 py-2 bg-[#011224] rounded-xl border border-white/10">
            {uploading ? (
    ...
    <div className="space-y-6z ">
      ...
      <div className="flex items-center justify-between gap-4 mb-6 flex-wrap">
        <div className="flex items-center gap-3">
          <div className="relative">
            <div className="absolute -inset-0.5 bg-gradient-to-r from-[#073F6F] to-[#315589] rounded-xl blur opacity-50" />
            <div className="relative w-9 h-9 bg-[#011224] rounded-xl border border-white/15 flex items-center justify-center">
        ...
        >
          <div className="absolute -inset-0.5 bg-gradient-to-r from-[#052F55] to-[#315589] rounded-xl opacity-50 blur group-hover:opacity-80 transition duration-300" />
          <div className="relative flex items-center gap-2 px-4 py-2.5 bg-[#011224] rounded-xl border border-white/10">
