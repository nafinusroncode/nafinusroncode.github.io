...
const SOCIAL_LINKS = [
  { icon: Github, link: profile.social.github, label: "GitHub Profile" },
  { icon: Linkedin, link: profile.social.linkedin, label: "LinkedIn Profile" },
  { icon: Instagram, link: profile.social.instagram, label: "Instagram Profile" },
  { icon: Youtube, link: profile.social.youtube, label: "YouTube Channel" },
];
...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{`${profile.fullName} - ${profile.title}`}</title>
        <meta name="description" content={`Website portofolio ${profile.fullName}, mahasiswa ${profile.department} ${profile.university} dengan fokus ${profile.focus}.`} />
     <meta name="robots" content="index, follow" />
        <link rel="canonical" href={profile.siteUrl} />
        <meta property="og:title" content={`${profile.fullName} - ${profile.title}`} />
     <meta property="og:description" content={profile.heroDescription} />
