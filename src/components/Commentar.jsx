...
const CommentForm = memo(({ onSubmit, isSubmitting, isDisabled }) => {
    ...
    }, [newComment, userName, imageFile, isDisabled, onSubmit]);
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
                ...
                className="relative w-full h-12 bg-gradient-to-r from-[#073F6F] to-[#315589] rounded-xl font-medium text-white overflow-hidden group transition-all duration-300 hover:scale-[1.02] hover:shadow-lg active:scale-[0.98] disabled:opacity-50 disabled:hover:scale-100 disabled:cursor-not-allowed"
            >
...
const Komentar = () => {
    ...
    const commentsEnabled = Boolean(supabase);
    ...
    const handleCommentSubmit = useCallback(async ({ newComment, userName, imageFile }) => {
        ...
        try {
            if (!commentsEnabled) {
                setError('Comments are not available because Supabase is not configured.');
                return;
            }
    ...
    return (
        <div className="w-full bg-gradient-to-b from-white/10 to-white/5 rounded-2xl  backdrop-blur-xl shadow-xl" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div className="p-6 space-y-6">
                ...
                {!commentsEnabled && (
                    <div className="flex items-center gap-2 p-4 text-blue-300 bg-blue-500/10 border border-blue-500/20 rounded-xl" data-aos="fade-in">
                        <AlertCircle className="w-5 h-5 flex-shrink-0" />
                        <p className="text-sm">Comments are offline until Supabase credentials are added.</p>
                    </div>
                )}
                
                <div>
                    <CommentForm onSubmit={handleCommentSubmit} isSubmitting={isSubmitting} isDisabled={!commentsEnabled} />
                </div>
            ...
            <style jsx>{`
                ...
                .custom-scrollbar::-webkit-scrollbar-thumb {
                    background: rgba(7, 63, 111, 0.5);
                    border-radius: 6px;
                }
                .custom-scrollbar::-webkit-scrollbar-thumb:hover {
                    background: rgba(7, 63, 111, 0.7);
                }
            `}</style>
        </div>
    );
