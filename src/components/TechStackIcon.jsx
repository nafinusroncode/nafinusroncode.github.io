    ...
    <div className="group p-6 rounded-2xl bg-slate-800/50 hover:bg-slate-700/50 transition-all duration-300 ease-in-out flex flex-col items-center justify-center gap-3 hover:scale-105 cursor-pointer shadow-lg hover:shadow-xl">
      <div className="relative">
        ...
        {TechStackIcon ? (
          ...
          <div className="relative h-16 w-16 md:h-20 md:w-20 rounded-2xl bg-gradient-to-br from-[#073F6F]/30 to-[#315589]/30 border border-white/10 flex items-center justify-center text-white font-bold text-lg md:text-xl transform transition-transform duration-300">
